 ...
 */
export type SpinnerPresetName = "dots" | "dots2" | "line" | "arrow" | "bouncingBar";
/**
 ...
 */
export interface PresetSpinnerProps extends Omit<SpinnerProps, "frames" | "interval" | "backgroundColor"> {
    /**
